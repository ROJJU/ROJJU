                ...
                <div class="item" style="background-image: url(/resources/images/slider/bg2.jpg); background-size:curver;">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1"><b style="color:#c52d2f;">ROJJU</b> People들의 연애고민</h1>
                                    <h2 class="animation animated-item-2">여러분의  <b style="font-size:30px;">연애관련 고민</b><br> 이제 <b style="font-size:30px; color:#c52d2f;">ROJJU</b>에서 함께 이야기 하세요</h2>
                ...
                <div class="item" style="background-image: url(/resources/images/slider/bg3.jpg); background-size:curver;">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">데이트 코스 넌 어디까지 가 봤니?</h1>
                                    <h2 class="animation animated-item-2">여러분의 데이트 코스<br> <b style="font-size:30px; color:#c52d2f;">ROJJU</b>에서  함께 공유해요!</h2>
                                    <a class="btn-slide animation animated-item-3" href="#">Link Page</a>
                                </div>
                            </div>
                            <div class="col-sm-6 hidden-xs animation animated-item-4">
    ...
    <section id="recent-works">
        <div class="container">
            <div class="center wow fadeInDown">
                ...
                <p class="lead">당신과 함께 하는 순간이 나에게는 최고의 시간입니다. 소중한 순간들을 기록하여 간직하세요.</p>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6 wow fadeInDown">
                    <div class="skill">
						...
						<div>
							<b style="color:#c52d2f; font-size:11px;">총 투표자수 : 110명</b>
							<table>
								<tr>
									<td><b style="background-color:#6aa42f;">&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
									<td>&nbsp;찬성 총계  <b style="color:#c52d2f; font-size:11px;">(투표자수:100명)</b></td>
									<td><b style="background-color:#2d7da4;">&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
									<td>&nbsp;A형 남자  <b style="color:#c52d2f; font-size:11px;">(투표자수:40명)</b></td>
								</tr>
								<tr>
									<td><b style="background-color:#ffcc33;">&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
									<td>&nbsp;반대 남자  <b style="color:#c52d2f; font-size:11px;">(투표자수:10명)</b></td>
									<td><b style="background-color:#db3615;">&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
									<td>&nbsp;A형 남자  <b style="color:#c52d2f; font-size:11px;">(투표자수:5명)</b></td>
								</tr>
							</table>
						</div>
                        <div class="progress-wrap">
                            <h3><b style="font-size:30px; color:#2d7da4;">찬성</b> <img src="/resources/images/help/good.gif" width="60px;"></h3>
							...
							찬성 총계   <b style="color:#c52d2f; font-size:11px;">(투표자수:100명)</b> :
                        </div>

                        <div class="progress-wrap">
                            <h3><b style="font-size:30px; color:#db3615;">반대</b> <img src="/resources/images/help/bad.gif" width="60px;"></h3>
                            <div class="progress">
                        ...
                        <p><center><br> <img src="/resources/images/common/coution.gif">&nbsp;자세한 통계현황은<b style="color:#c52d2f;"> [Read More > 투표 자세히보기]</b> 를 눌러주세요</center></p>
                    </div>
